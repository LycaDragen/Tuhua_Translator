...
class DeepLEngine {
  constructor(apiKey, options = {}) {
    ...
    log.info(`[DeepL] Initialized: endpoint=${this.baseUrl}, hasKey=${!!this.apiKey}, keyType=${this.apiKey?.endsWith(':fx') ? 'Free' : 'Pro/Unknown'}, formality=${this.formality}, customInstructions=${this.customInstructions.length}${usingDefaults ? ' (using ' + DEFAULT_INSTRUCTIONS.length + ' defaults)' : ''}`);
  }
